...
def addTrade():
    ...
    #Style
    if BuyOrSell == "S" or BuyOrSell == "Sell" or BuyOrSell == "sell":
    ...
    elif BuyOrSell == "B" or BuyOrSell == "Buy" or BuyOrSell == "buy":
        for i in range(1, maxColumn):
    ...
    if friend == "n" or friend == "no" or friend == "No":
        currentCell.value = "NO"
        currentCell.fill = solidRedFill
        currentCell.alignment = Alignment(horizontal='center')
    elif friend == "y" or friend == "yes" or friend == "Yes":
